    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {/* <div className="bg-gray-900 text-white py-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mb-6">Get top stories every week in your inbox.</p>
          {submitted ? (
            ...
            >
              <input type="text" placeholder="Your Name" value={name} onChange={(e) => setName(e.target.value)} className="px-4 py-2 rounded bg-gray-700" required />
              <input type="text" placeholder="Your Favourite MLS Club" value={favoriteMLSClub} onChange={(e) => setFavoriteMLSClub(e.target.value)} className="px-4 py-2 rounded bg-gray-700" required />
              <input type="email" placeholder="Your Email" value={email} onChange={(e) => setEmail(e.target.value)} className="px-4 py-2 rounded bg-gray-700" required />
              <button type="submit" className="bg-blue-600 hover:bg-blue-500 px-6 py-2 rounded">Subscribe</button>
            </form>
          )}
        </div>
      </div> */}
