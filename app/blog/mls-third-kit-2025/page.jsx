...
const MLSThirdKitBlog = () => {
  const products = [
    ...
    },
    {
      ...
      A nostalgic throwback to MLS’s early years and a true collector’s piece.`
    },
    {
      ...
      text: `Inspired by Miami sunsets, the light blue and pink details capture the city’s unique identity. 
    ...
    },
    {
      ...
      text: `With shades of green and the bold “Clash” script, this kit draws inspiration from Mexican football culture. 
    ...
    },
    {
        ...
        It’s an authentic old-school look that makes this kit one of the most original in the entire collection.`
      },
      {
        ...
        text: `As one of MLS’s newer clubs, Charlotte FC is already making a mark. Their teal-green third kit, featuring the crown emblem, is bold, refreshing, 
      ...
      },
      {
        ...
        text: `D.C. United, one of the league’s most decorated clubs, brings back a design that echoes their championship-winning DNA. 
        For longtime supporters, this jersey is a reminder of the glory years and a tribute to the club’s historic legacy.`
      }
  ];
    ...
    <div className='w-full min-h-screen bg-white'>
      <div className='max-w-4xl mx-auto py-8 px-4 md:px-0'>
        ...
        <div className='mb-4 text-sm text-gray-600'>
          <p>By: Mio Ristić | July 2, 2025</p>
          <p className='mt-1 text-xs text-gray-400'>Image © MLS Official Site</p>
        </div>

        <div className='space-y-4 mb-10 text-[#020617] text-lg'>
          <p className='text-2xl font-semibold'>🎨 Retro Vibes Return to MLS</p>
          <p>
            The 2025 MLS season introduces a line of third kits that take fans back to the roots of soccer in North America —
        ...
        <div className='mt-16'>
          <h2 className='text-xl font-semibold mt-6'>👕 Bonus Pick – LAFC x NTS Radio Fashion Jersey</h2>
          <p className='mb-6'>
            Not an official third kit, but a fashion-forward collaboration that blends football with streetwear. 
            Minimalist gray, subtle detailing, and NTS Radio’s touch make this jersey perfect both on the terraces and the streets.
          </p>
