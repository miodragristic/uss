...
const TrendingPlayers = ({ teamSlug = 'houston-dynamo' }) => {
  const players = [
    ...
    { name: 'Sebastian Kowalczyk', image: 'https://daf17zziboaju.cloudfront.net/wp-content/uploads/2024/11/07072140/2WMMX2H-1.jpg', slug: './kowalczyk' },
    ...
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        {players.map((player) => (
          <Link
            key={player.slug}
            href={`/teams/houston-dynamo/${player.slug}`}
