...
// Blog komponenta
const Blog = () => {
  // Dodaj 'slug' za svaki post da Link radi ispravno
  const blogPosts = [
    {
      id: 20,
      title: 'Walker Zimmerman Is Back',
      ...
      date: 'May 26, 2025',
      excerpt:
        'After a period sidelined by injury, Walker Zimmerman returns to strengthen Nashville SC’s defense.',
      imageUrl:
        'https://the18.com/sites/default/files/styles/x-large_square__4_3_/public/feature-images/20220429-The18-Image-Walker-Zimmerman-GettyImages-1316150108.jpeg?itok=dewBb8Ju',
      slug: 'zimmerman-is-back',
    },
  ];

  // visiblePosts možeš menjati u skladu sa filtriranjem ili paginacijom
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {visiblePosts.map((post) => (
            ...
            >
              ...
              <div className="p-4">
                <h2 className="text-xl font-bold group-hover:text-blue-600 transition duration-300">
                  {post.title}
                </h2>
